...
while resposta == 'sim':
	print('Este é um programa que irá calcular sistemas lineares 2x2 e 3x3. Comece digitando o número que representa a quantidades de linhas e colunas.')
	escolha = int(input('Digite 2 para sistemas 2x2 e 3 para sistemas 3x3:'))
	...
	while resposta not in ('sim', 'não'):
			print('Resposta inválida. Digite sim ou não. (sim/não)\n')